...
int main() {
  ...
  addCube("resources/beige-textures/beige_wall_001_diff_4k.jpg", "resources/beige-textures/beige_wall_001_diff_4k.jpg", glm::vec3(0.0f, -1.5f, 0.0f), glm::vec3(1.0f), 0.0f, 1.0f); 
